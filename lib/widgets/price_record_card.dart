...
/// A premium card widget for displaying price records consistently.
class PriceRecordCard extends StatelessWidget {
  const PriceRecordCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final isCheapest = isCheapestOverride ?? (record.isBestPrice ?? false);
