...
- Auth & profile: Guest/Google/Apple/email, guest-to-user data migration (including identity_already_exists), existing-email login with guest merge, in-app password reset dialog on Supabase passwordRecovery deep link.
